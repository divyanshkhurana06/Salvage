"""Mainnet addresses and the minimal ABIs Salvage needs.

Everything here is read against a local Anvil fork of Ethereum mainnet, so the
addresses are the real mainnet ones.
"""
...
# Tokens we can price. symbol -> (token address, Chainlink USD feed)
PRICED_TOKENS: dict[str, tuple[str, str]] = {
